...
public class ModFluids {
	...
	public static Fluid enchantedFluid = new FluidEnchantedLiquid("enchanted", new ResourceLocation(Reference.MOD_ID, "fluids/enchanted_still"), new ResourceLocation(Reference.MOD_ID, "fluids/enchanted_flow")).setMaterial(ModMaterials.ENCHANTED).setDensity(100).setGaseous(false).setLuminosity(2).setViscosity(25000).setTemperature(300);
